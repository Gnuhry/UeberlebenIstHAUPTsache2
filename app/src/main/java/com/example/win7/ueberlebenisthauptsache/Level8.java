...
Weg=new ImageView[53];
int [] GegIndex=new int[3];
...
Weg[50]=(ImageView)findViewById(R.id.Weg50);
Weg[51]=(ImageView)findViewById(R.id.Weg51);
Weg[52]=(ImageView)findViewById(R.id.Weg52);
...
npc[4]=(ImageView)findViewById(R.id.NPC4);
npc[5]=(ImageView)findViewById(R.id.NPC5);
npc[6]=(ImageView)findViewById(R.id.NPC6);
npc[7]=(ImageView)findViewById(R.id.NPC7);
gegenstand=new Gegenstand(Gegenstande,GegIndex,(ImageView)findViewById(R.id.keyanzeige),this,8,mediaPlayer);
}}
